				...
				<mj-head>
					<mj-attributes>
						...
						<mj-accordion-element
							icon-wrapped-url="http://i.imgur.com/Xvw0vjq.png"
							icon-unwrapped-url="http://i.imgur.com/KKHenWa.png"
							icon-height="24px"
							icon-width="24px"
						/>
						<mj-accordion-title
								...
								<mj-accordion-element>
									...
									<mj-accordion-text>
										<span style={{ lineHeight: '20px' }}>
											...
											{'experience on mobile, mj-accordion comes handy when you want to deliver '}
