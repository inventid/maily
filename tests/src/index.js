...
import MjmlCarousel from './mjml-carousel';
...
import mjmlNavbar from './mjml-navbar';
import mjmlRaw from './mjml-raw';
import mjmlSection from './mjml-section';
import mjmlSocial from './mjml-social';
...
export default {
	...
	// They deserve a lot of credit for creating MJML!
	mjmlAccordion,
	mjmlBody,
	mjmlButton,
	MjmlCarousel,
